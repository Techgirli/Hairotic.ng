  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 select-none font-sans">
      ...
      <div className="space-y-4">
        ...
        <div className="relative h-[340px] sm:h-[480px] rounded-[24px] overflow-hidden bg-[#FAF7F4] border border-[#222222]/5">
          <img
            src={activeImage}
            alt={product.name}
          ...
          <div className="flex gap-4 overflow-x-auto pb-2">
            {selectedVariant.images.map((img) => (
              <button
                ...
                className={`w-16 h-16 sm:w-20 sm:h-20 rounded-[12px] overflow-hidden bg-[#FAF7F4] border-2 shrink-0 transition-all duration-200 ${
      ...
      <div className="space-y-8">
        <div className="space-y-3">
          <h2 className="text-[24px] sm:text-[28px] md:text-[36px] font-bold text-[#222222] uppercase tracking-wide leading-tight">
            {product.name}
          </h2>
        ...
        <div className="flex items-baseline gap-4 py-2 border-y border-[#222222]/5">
          <span className="text-[28px] sm:text-[32px] font-extrabold text-[#E56717]">
            ₦{priceInNgn.toLocaleString()}
          </span>
          {comparePriceInNgn && (
            <span className="text-[16px] sm:text-[18px] text-[#6B7280] line-through font-medium">
        ...
        <div className="space-y-2">
          ...
          <p className="text-[15px] sm:text-[16px] text-[#6B7280] leading-relaxed font-light">{product.description}</p>
        </div>
