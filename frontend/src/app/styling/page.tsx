    ...
    <>
      ...
      <main className="min-h-screen bg-[#FDFBF7] text-[#222222] font-sans">
        ...
        <section className="relative h-[60vh] flex items-center justify-center bg-[#222222] text-[#FFFFFF] overflow-hidden select-none">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center z-10 space-y-6">
            <span className="text-[#E56717] text-[13px] sm:text-[14px] uppercase tracking-[0.3em] font-bold block">
              Hairotic Salon Services
            </span>
            <h1 className="font-display text-[32px] sm:text-[44px] md:text-[60px] font-black uppercase tracking-tight leading-none text-[#FFFFFF]">
              Wig Styling & <br />
              <span className="text-[#E56717]">Lace Installation</span>
            </h1>
            <p className="text-[15px] sm:text-[17px] text-[#E5E7EB] max-w-2xl mx-auto font-medium leading-relaxed">
            ...
            <div className="pt-4">
              <a 
                ...
                className="inline-flex items-center gap-2 bg-[#E56717] hover:bg-[#D4560F] text-[#FFFFFF] px-6 sm:px-8 py-3.5 sm:py-4 rounded-full font-bold uppercase tracking-wider text-[13px] sm:text-[14px] shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 hover:shadow-xl cursor-pointer"
              >
        ...
        <section className="py-12 sm:py-20 px-4 sm:px-8 max-w-7xl mx-auto">
          <div className="text-center space-y-4 mb-12 sm:mb-16">
            ...
            <h2 className="font-display text-[26px] sm:text-[32px] md:text-[40px] font-black uppercase text-[#222222]">Our Styling Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10">
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  <div className="relative w-full md:w-2/5 h-56 sm:h-64 md:h-auto overflow-hidden">
                    <Image
                      src={service.image}
                      alt={service.title}
                      fill
                  ...
                  <div className="p-6 sm:p-8 w-full md:w-3/5 flex flex-col justify-between space-y-6">
                    <div className="space-y-3">
                      ...
                      <h3 className="text-[18px] sm:text-[20px] font-black uppercase text-[#222222] tracking-wide leading-tight">
                        {service.title}
                      </h3>
        ...
        {/* Process Explanation */}
        <section className="bg-[#222222] text-[#FFFFFF] py-12 sm:py-20 px-4 sm:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center space-y-4 mb-12 sm:mb-16">
              <span className="text-[#E56717] text-[13px] uppercase tracking-[0.2em] font-bold block">How It Works</span>
              <h2 className="font-display text-[26px] sm:text-[32px] md:text-[40px] font-black uppercase text-[#FFFFFF]">The Styling Process</h2>
              <div className="h-1 w-20 bg-[#E56717] mx-auto" />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {steps.map((step, index) => (
                <div 
                  key={index}
                  className="bg-[#2D2D2D] border border-[#FFFFFF]/5 p-6 sm:p-8 rounded-2xl relative overflow-hidden group hover:border-[#E56717]/30 transition-all duration-300"
                >
                  <span className="absolute -top-4 -right-2 font-display text-[80px] sm:text-[96px] font-black text-[#FFFFFF]/5 select-none transition-colors group-hover:text-[#E56717]/10 duration-300">
                    {step.number}
                  </span>
                  <div className="h-12 w-12 bg-[#E56717]/10 text-[#E56717] font-bold text-[18px] rounded-full flex items-center justify-center mb-6">
                    {step.number}
                  </div>
                  <h3 className="text-[16px] sm:text-[18px] font-black uppercase tracking-wider text-[#FFFFFF] mb-3">
                    {step.title}
                  </h3>
        ...
        <section className="py-12 sm:py-20 px-4 sm:px-8 text-center max-w-4xl mx-auto space-y-6 sm:space-y-8">
          <Sparkles className="w-10 h-10 sm:w-12 sm:h-12 text-[#E56717] mx-auto animate-pulse" />
          <h2 className="font-display text-[26px] sm:text-[32px] md:text-[40px] font-black uppercase text-[#222222]">Have Questions About the Process?</h2>
          <p className="text-[14px] sm:text-[16px] text-[#6B7280] leading-relaxed max-w-2xl mx-auto">
