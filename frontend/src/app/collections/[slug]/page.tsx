...
export default async function CollectionPage({ params, searchParams }: PageProps) {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen">
      ...
      <section className="bg-[#FFF8F2] border-b border-[#222222]/5 py-8 sm:py-12 select-none">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-3">
          <span className="text-[#E56717] text-[13px] uppercase tracking-[0.25em] font-bold block">
            Exclusive Collection
          </span>
          <h2 className="text-[28px] sm:text-[36px] md:text-[48px] font-bold text-[#222222] uppercase tracking-wide leading-tight">
            {collection.name}
          </h2>
          <p className="text-[#6B7280] text-[14px] sm:text-[16px] max-w-2xl font-light">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 flex-1 flex flex-col lg:flex-row gap-8">
        {/* Filters Sidebar */}
        ...
        <div className="flex-1 space-y-6">
          ...
          {products.length > 0 ? (
                ...
                return (
                  ...
                  >
                    <div className="space-y-4">
                      ...
                      <div className="relative h-[240px] sm:h-[260px] rounded-[20px] overflow-hidden bg-[#FAF7F4] border border-[#222222]/5">
                        <img
                          src={mainImage}
                          alt={product.name}
            ...
            /* Empty state */
            <div className="bg-[#FAF7F4] border border-[#222222]/5 rounded-[24px] p-12 sm:p-16 text-center select-none space-y-4">
