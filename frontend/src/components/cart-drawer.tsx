...
export default function CartDrawer() {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden select-none font-sans flex justify-end">
      {/* Dark blur overlay backdrop */}
      <div 
        onClick={() => toggleDrawer(false)}
        className="absolute inset-0 bg-[#222222]/60 backdrop-blur-sm transition-opacity duration-300 cursor-pointer" 
      />

      <div
        ref={drawerRef}
        className="relative w-full max-w-md bg-white flex flex-col shadow-2xl h-full z-10"
      >
        {/* Header */}
